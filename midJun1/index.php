...
if(isset($_POST['button'])){
    if(!empty($_POST['email'])){
        ...
        if(filter_var($email,FILTER_VALIDATE_EMAIL)){
            $query = "INSERT INTO email (id, email, date) VALUES (NULL, '$email', '$date')";
  ...
  <body>
    <div class="wrapper">
      <aside id="aside">
        <div class="top-bar">
          <div class="logo">
            <img class="logo-01" width="25px" height="40px" src="images/union.png" alt="">
            <img class="logo-02" width="78px" height="16px" src="images/pineapple.png" alt="" style="margin-bottom: 4px;">
          </div>
          <ul>
            <li><a href="#">About</a></li>
            <li><a href="database.php">How it works</a></li>
            <li><a href="#">Contact</a></li>
          </ul>
        </div>
        <div class="portable-device">
            <div id="mainText" class="main-text">
                <div class="heading-01">
                    Subscribe to newsletter
                </div>
                <div class="subheading-01">
                    Subsribe to out newsletter and get 10% discount <br>on pineapple glasses.
                </div>
            </div>
            <form id="form" class="input-container" method="POST">
                <div class="line">
                </div>
                <input id="email" onkeydown="inputCheck()" class="input-01" type="text" name="email" value="" placeholder="Type your email address here…">
                <button type="submit" onclick="onClickCheck()" name="button" style="border: none; background-color: white; outline: none;">
                    <svg class="input-arrow" width="24" height="14" viewBox="0 0 24 14" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg class="input-arrow-mobile" width="24" height="14" viewBox="0 0 24 14" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.7071 0.2929C17.3166 -0.0976334 16.6834 -0.0976334 16.2929 0.2929C15.9023 0.683403 15.9023 1.31658 16.2929 1.70708L20.5858 5.99999H1C0.447693 5.99999 0 6.44772 0 6.99999C0 7.55227 0.447693 7.99999 1 7.99999H20.5858L16.2929 12.2929C15.9023 12.6834 15.9023 13.3166 16.2929 13.7071C16.6834 14.0976 17.3166 14.0976 17.7071 13.7071L23.7071 7.70708C24.0977 7.31658 24.0977 6.6834 23.7071 6.2929L17.7071 0.2929Z" />
                    </svg>
                </button>
            </form>
    ...
    <span id="emailError">
        ...
        ?>
            ...
            <div id="rules" class="rules">
                <input id="myCheck"  onchange="checkClick()" type="checkbox" name="" value="">
                <div>I agree to <a href="#">terms of service</a></div>
            </div>
            <div class="hr"></div>
            <div class="social-media">
                <a href="#">
                    <div class="icon-box-01">
                        <svg  class="icon-01" width="8" height="16" viewBox="0 0 8 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="#">
                    <div class="icon-box-02">
                        <svg  class="icon-02" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="#">
                    <div class="icon-box-03">
                        <svg  class="icon-03" width="16" height="13" viewBox="0 0 16 13" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="#">
                    <div class="icon-box-04">
                        <svg class="icon-04" width="16" height="11" viewBox="0 0 16 11" xmlns="http://www.w3.org/2000/svg">
